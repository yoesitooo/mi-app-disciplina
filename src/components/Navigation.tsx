...
export default function Navigation() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-sm bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 p-2 rounded-3xl flex justify-around shadow-2xl z-50">
      {tabs.map((tab) => {
